A DANGER VIRUS.exe is a malware creates flashy screen effects and voice.Just now the malware can Modulate your radio. Supported systems: Windows Vista+ The destruction part has been written yet, so feel to run it on your virtual computer.
